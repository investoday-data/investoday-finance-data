...
| `reportType` | 报告类型 | `Q1` |
| `fiscalPeriod` | 会计期间 | `9` |
| `cashRecvSales` | 销售商品提供劳务现金流入（元） | `12450000` |
| `cashRecvDepositIncrease` | 客户存款同业存放净增加额（元） | `123456789` |
| `cashRecvBorrowingCb` | 央行借款净增加额（元） | `1250000000` |
| `cashRecvPremiumInsurance` | 原保险合同保费现金流入（元） | `1234567.89` |
| `cashRecvPolicyFundsNet` | 保户储金投资款净增加额（元） | `12345678.9` |
| `cashRecvTradingAssetsNet` | 处置交易性金融资产净增加额（元） | `-1250000` |
| `cashRecvInterestFee` | 利息手续费佣金现金流入（元） | `12345.67` |
| `cashRecvTaxRefund` | 税费返还现金流入（元） | `123456.78` |
| `cashRecvOtherOperating` | 其他经营活动现金流入（元） | `500000` |
...
| `cfo` | 经营活动现金流量净额（元） | `12345678.9` |
| `cashRecvDisposalInvestments` | 收回投资现金流入（元） | `1250000` |
| `cashRecvInvestIncome` | 投资收益现金流入（元） | `1250000` |
| `cashRecvAssetDisposal` | 处置长期资产收回现金净额（元） | `1250000` |
